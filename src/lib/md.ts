// Lightweight Markdown renderer for product descriptions (build-time, Astro).
// Mirrors functions/_md.js so static detail pages render the same way the
// server-rendered detail pages do.
